...
extern class PhysicsModule {
	...
	@:overload(function(body1:Body, body2:Body, x1:Float, y1:Float, x2:Float, y2:Float, ax:Float, ay:Float, ?collideConnected:Bool,
		?referenceAngle:Float):PrismaticJoint {})
	...
	public static function newPulleyJoint(body1:Body, body2:Body, gx1:Float, gy1:Float, gx2:Float, gy2:Float, x1:Float, y1:Float, x2:Float, y2:Float,
		?ratio:Float, ?collideConnected:Bool):PulleyJoint;
