...
extern class GraphicsModule {
	...
	public static function drawInstanced(mesh:Mesh, instancecount:Float, ?x:Float, ?y:Float, ?r:Float, ?sx:Float, ?sy:Float, ?ox:Float, ?oy:Float, ?kx:Float,
		?ky:Float):Void;

	@:overload(function(texture:Texture, layerindex:Float, quad:Quad, ?x:Float, ?y:Float, ?r:Float, ?sx:Float, ?sy:Float, ?ox:Float, ?oy:Float, ?kx:Float,
		?ky:Float):Void {})
	...
	public static function drawLayer(texture:Texture, layerindex:Float, ?x:Float, ?y:Float, ?r:Float, ?sx:Float, ?sy:Float, ?ox:Float, ?oy:Float, ?kx:Float,
		?ky:Float):Void;
	...
	public static function newQuad(x:Float, y:Float, width:Float, height:Float, image:Image):Quad;
	...
	@:overload(function(coloredtext:Table<Dynamic, Dynamic>, ?x:Float, ?y:Float, ?angle:Float, ?sx:Float, ?sy:Float, ?ox:Float, ?oy:Float, ?kx:Float,
		?ky:Float):Void {})
	...
	@:overload(function(text:String, font:Font, x:Float, y:Float, limit:Float, ?align:AlignMode, ?r:Float, ?sx:Float, ?sy:Float, ?ox:Float, ?oy:Float,
		?kx:Float, ?ky:Float):Void {})
	...
	@:overload(function(coloredtext:Table<Dynamic, Dynamic>, x:Float, y:Float, limit:Float, align:AlignMode, ?angle:Float, ?sx:Float, ?sy:Float, ?ox:Float,
		?oy:Float, ?kx:Float, ?ky:Float):Void {})
	@:overload(function(coloredtext:Table<Dynamic, Dynamic>, font:Font, x:Float, y:Float, limit:Float, ?align:AlignMode, ?angle:Float, ?sx:Float, ?sy:Float,
		?ox:Float, ?oy:Float, ?kx:Float, ?ky:Float):Void {})
	...
	public static function printf(text:String, x:Float, y:Float, limit:Float, ?align:AlignMode, ?r:Float, ?sx:Float, ?sy:Float, ?ox:Float, ?oy:Float,
		?kx:Float, ?ky:Float):Void;
