...
extern class SpriteBatch extends Drawable {
	...
	@:overload(function(spriteindex:Float, layerindex:Float, quad:Quad, ?x:Float, ?y:Float, ?r:Float, ?sx:Float, ?sy:Float, ?ox:Float, ?oy:Float, ?kx:Float,
		?ky:Float):Void {})
	...
	public function setLayer(spriteindex:Float, layerindex:Float, ?x:Float, ?y:Float, ?r:Float, ?sx:Float, ?sy:Float, ?ox:Float, ?oy:Float, ?kx:Float,
		?ky:Float):Void;
