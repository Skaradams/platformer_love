...
extern class Text extends Drawable {
	...
	@:overload(function(coloredtext:Table<Dynamic, Dynamic>, wraplimit:Float, align:AlignMode, x:Float, y:Float, ?angle:Float, ?sx:Float, ?sy:Float,
		?ox:Float, ?oy:Float, ?kx:Float, ?ky:Float):Float {})
	public function addf(textstring:String, wraplimit:Float, align:AlignMode, x:Float, y:Float, ?angle:Float, ?sx:Float, ?sy:Float, ?ox:Float, ?oy:Float,
