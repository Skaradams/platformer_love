...
extern class Transform extends Object {
	...
	@:overload(function(layout:MatrixLayout, e1_1:Float, e1_2:Float, e1_3:Float, e1_4:Float, e2_1:Float, e2_2:Float, e2_3:Float, e2_4:Float, e3_1:Float,
		e3_2:Float, e3_3:Float, e3_4:Float, e4_1:Float, e4_2:Float, e4_3:Float, e4_4:Float):Transform {})
	@:overload(function(layout:MatrixLayout, matrix:Table<Dynamic, Dynamic>):Transform {})
	@:overload(function(layout:MatrixLayout, matrix:Table<Dynamic, Dynamic>):Transform {})
	public function setMatrix(e1_1:Float, e1_2:Float, e1_3:Float, e1_4:Float, e2_1:Float, e2_2:Float, e2_3:Float, e2_4:Float, e3_1:Float, e3_2:Float,
		e3_3:Float, e3_4:Float, e4_1:Float, e4_2:Float, e4_3:Float, e4_4:Float):Transform;
